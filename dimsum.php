...
<body>
    ...
    <section class="showcase-area" id="showcase" style="background-image: url('images/Dimsum logo.jpg');">
    </section>
    ...
    <?php
        ...
        try {
            ...
            $stmt->execute(['restaurantID' => 6]); // Replace 1 with the actual restaurant ID
