...
<body>
    ...
    <section class="showcase-area" id="showcase" style="background-image: url('images/Manhattan fish logo.jpg');">
    </section>
    ...
    <?php
        ...
        try {
            ...
            $stmt->execute(['restaurantID' => 4]); // Replace 1 with the actual restaurant ID
